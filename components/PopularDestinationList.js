...
import PopularDestinationListItem from './PopularDestinationListItem'
import { connect } from "react-redux";

class PopularDestinationList extends Component {
  constructor(props){
    super(props);
  }
      ...
      <View style={styles.container}>
        ...
        <View style={styles.list}>
          <View style={styles.left}>
            <FlatList
              data={this.filter(this.props.popular_destinations, 'odd')}
          ...
          <View style={styles.right}>
            <FlatList
              data={this.filter(this.props.popular_destinations, 'even')}
              extraData={this.state}
              keyExtractor={this._keyExtractor}
              renderItem={this._renderItem}
            />
...
export default connect(mapStateToProps, null)(PopularDestinationList)
